...
import { useCreatePolicy } from '@applications/queries/abac'
...
export default function CreatePolicyDialog({ open, onOpenChange }: CreatePolicyDialogProps) {
  ...
  return (
    <Dialog.Root open={open} onOpenChange={handleOpenChange}>
      <Dialog.Content style={{ maxWidth: 800, maxHeight: '90vh' }}>
        <Dialog.Title>Create New Policy</Dialog.Title>
        <Dialog.Description size="2" mb="4">
          Create a new ABAC policy with conditions and effects
        </Dialog.Description>
